...
?>
					<tr data-type="element" data-id="<?php echo $user->id; ?>">
						...
						<td>
							<?php
							if($role == 1 || $role == 2)
								echo '<a href="edit-user.php?userid='.$user->id.'" name="c3" title="Edit User"><i class="fa fa-pencil-alt"></i></a>';
							?>
							<a href="logs.php?userid=<?php echo $user->id; ?>" name="c4" title="Log of this user"><i class="fa fa-file-alt"></i></a>
							<?php
							if($role == 1 || $role == 2)
								echo '<a href="" name="c5" title="Delete User"><i class="fa fa-times"></i></a>';
							?>
						</td>
					</tr>
<?php
