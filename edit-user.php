					...
					<form method="post" action="" name="edit-user" data-id="<?php echo $userd->id; ?>">
						...
						<div class="select-holder">
							...
							<select name="euser-role">
								<option value="1"<?php if($userd->role == 1) echo ' selected'; ?>>Manager</option>
								<option value="2"<?php if($userd->role == 2) echo ' selected'; ?>>Assistant Manager</option>
								<option value="3"<?php if($userd->role == 3) echo ' selected'; ?>>Cashier</option>
