...
?>
					<tr data-type="element" data-id="<?php echo $cat->id;?>">
						...
						<td>
							<?php
							if($role == 1 || $role == 2)
								echo '<a href="edit-category.php?id='.$cat->id.'" name="c3" title="Edit Item"><i class="fa fa-pencil-alt"></i></a>';
							if($role == 1 || $role == 2 || $role == 3)
								echo '<a href="logs.php?catid='.$cat->id.'" name="c4" title="Log of this category"><i class="fa fa-file-alt"></i></a>';
							if($role == 1 || $role == 2)
