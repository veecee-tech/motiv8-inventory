	...
	<div id="main-wrapper">
		...
		<div class="wrapper-pad">
			...
			<div id="table-head">
				...
				<?php
				if($role == 1 || $role == 2)
					echo '<a href="" name="delete-all" class="btn red disabled fright"><i class="fa fa-times"></i>Delete Items</a>';
				?>
...
?>
					<tr data-type="element" data-id="<?php echo $item->id; ?>">
						...
						<td class="hover" data-type="id"><?php echo $i++; //$item->id; ?></td>
						...
						<td>
							...
							<?php
							if($role == 1 || $role == 2)
								echo '<a href="edit-item.php?id='.$item->id.'" name="c3" title="Edit Item"><i class="fa fa-pencil-alt"></i></a>';
							if($role == 1 || $role == 2 || $role == 3)
								echo '<a href="logs.php?itemid='.$item->id.'" name="c4" title="Log"><i class="fa fa-file-alt"></i></a>';
							if($role == 1 || $role == 2)
								echo '<a href="" name="c5" title="Delete Item"><i class="fa fa-times"></i></a>';
							?>
						</td>
					</tr>
<?php
