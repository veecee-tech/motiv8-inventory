...
$('document').ready(function() {
	...
	$('table#items-check tbody tr').click(function() {
		...
		if($('tr[data-id='+id+']').next().data('id') != 'y') {
			var cont = $("<tr style=\"display:none\" data-id=\"y\"><td></td><td></td><td></td><td><form method=\"post\" data-saveid=\""+id+"\" name=\""+text+"\"><input type=\"text\" class=\"num\" placeholder=\"# of items\" /></form></td><td><input type=\"submit\" value=\"Add To Cart\" class=\"btn blue save "+text+"\" /></td><td></td></tr>");
